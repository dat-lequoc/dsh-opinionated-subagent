...
import { installTeamModelBridge } from './effort.js'
...
export const SETTINGS_NS = 'dsh-subagent-model'
...
export function apply(ctx) {
  ...
  ctx.inject(['subagents', 'llm'], (teamCtx) => {
    installTeamModelBridge(teamCtx)
  })

  ctx.inject(['tools'], (toolsCtx) => {
    installSmartWait(toolsCtx)
  })

  ctx.inject(['settings'], (settingsCtx) => {
    settingsCtx.settings.installSection(ctx, SETTINGS_NS, SettingsSchema, DEFAULTS, {
